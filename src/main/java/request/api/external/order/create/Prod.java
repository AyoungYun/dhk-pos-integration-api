...
public class Prod {
    ...
    private String prodNm; // 상품명 (ex. 간짜장)
    private Integer qty; // 상품 수량 (ex. 2)
    private Integer price; // 상품 가격 (ex. 5000)
    private String discountType; // 할인 유형 - amount, percent (ex. amount)
    private Integer discount; // 할인 금액 (ex. 1000)
    private List<Option> option; // 상품 속성
    private List<Side> sides; // 세트 메뉴 추가 상품
