package request.api.oauth.token;
...
public class IssueToken {
    ...
    String grant_type; // 인증방식 - 고정값 (client_credentials)
    String client_id; // 제휴사 발급 아이디 (ex. apiclient)
    String client_secret; // 제휴사 발급 비밀번호 (ex. apisecret)
}
